		...
		<div class="row">
            <div class="col-lg-12 margin-tb">
			 ...
			 <table class="table table-bordered">
			      <thead>
		    	<tr>
			        <td style="text-align:center" ><a class="btn btn-info" href="{{url('show')}}">Customer_name</a></td>
					<td style="text-align:center"><a class="btn btn-info" href="{{route('orders.index')}}">Place Order</a></td>
